<?php
	...
	function getHumeurs($userId) {
		$pdo = getPDO();
		$sql = "SELECT humeur.DATE_HEURE, humeur.DESCRIPTION, emotion.NOM FROM utilisateur join humeur on ID_UTILISATEUR = CODE_UTILISATEUR join emotion on humeur.CODE_EMOTION = emotion.ID_EMOTION WHERE CODE_UTILISATEUR = :user_id ORDER BY DATE_HEURE DESC LIMIT 5";
